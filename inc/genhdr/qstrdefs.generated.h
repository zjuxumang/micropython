...
QDEF(MP_QSTR_CameraGetAwb, (const byte*)"\xfe\x0c" "CameraGetAwb")
QDEF(MP_QSTR_CameraGetFPS, (const byte*)"\x0f\x0c" "CameraGetFPS")
QDEF(MP_QSTR_CameraGetRotate, (const byte*)"\x73\x0f" "CameraGetRotate")
QDEF(MP_QSTR_CameraGetZoom, (const byte*)"\x5d\x0d" "CameraGetZoom")
QDEF(MP_QSTR_CameraSetAwb, (const byte*)"\x6a\x0c" "CameraSetAwb")
QDEF(MP_QSTR_CameraSetFPS, (const byte*)"\x9b\x0c" "CameraSetFPS")
QDEF(MP_QSTR_CameraSetRotate, (const byte*)"\x67\x0f" "CameraSetRotate")
QDEF(MP_QSTR_CameraSetZoom, (const byte*)"\x49\x0d" "CameraSetZoom")
QDEF(MP_QSTR_GetValue, (const byte*)"\x78\x08" "GetValue")
QDEF(MP_QSTR_LEDsetColor, (const byte*)"\x97\x0b" "LEDsetColor")
QDEF(MP_QSTR_LEDsetMode, (const byte*)"\x89\x0a" "LEDsetMode")
QDEF(MP_QSTR_MuVisionSensor, (const byte*)"\x4f\x0e" "MuVisionSensor")
...
QDEF(MP_QSTR_SetValue, (const byte*)"\xec\x08" "SetValue")
...
QDEF(MP_QSTR_VisionGetLevel, (const byte*)"\x41\x0e" "VisionGetLevel")
QDEF(MP_QSTR_VisionGetOutputMode, (const byte*)"\x4b\x13" "VisionGetOutputMode")
...
QDEF(MP_QSTR_VisionSetLevel, (const byte*)"\xd5\x0e" "VisionSetLevel")
QDEF(MP_QSTR_VisionSetOutputEnable, (const byte*)"\x7d\x15" "VisionSetOutputEnable")
QDEF(MP_QSTR_VisionSetOutputMode, (const byte*)"\x5f\x13" "VisionSetOutputMode")
QDEF(MP_QSTR_VisionSetStatus, (const byte*)"\x37\x0f" "VisionSetStatus")
QDEF(MP_QSTR_begin, (const byte*)"\x82\x05" "begin")
QDEF(MP_QSTR_muvs, (const byte*)"\xf8\x04" "muvs")
QDEF(MP_QSTR_VISION_COLOR_DETECT, (const byte*)"\xbb\x13" "VISION_COLOR_DETECT")
QDEF(MP_QSTR_VISION_COLOR_RECOGNITION, (const byte*)"\xbb\x18" "VISION_COLOR_RECOGNITION")
QDEF(MP_QSTR_VISION_BALL_DETECT, (const byte*)"\xa5\x12" "VISION_BALL_DETECT")
QDEF(MP_QSTR_VISION_BODY_DETECT, (const byte*)"\xd6\x12" "VISION_BODY_DETECT")
QDEF(MP_QSTR_VISION_SHAPE_CARD_DETECT, (const byte*)"\x02\x18" "VISION_SHAPE_CARD_DETECT")
QDEF(MP_QSTR_VISION_TRAFFIC_CARD_DETECT, (const byte*)"\x20\x1a" "VISION_TRAFFIC_CARD_DETECT")
QDEF(MP_QSTR_VISION_NUM_CARD_DETECT, (const byte*)"\xbb\x16" "VISION_NUM_CARD_DETECT")
QDEF(MP_QSTR_VISION_ALL, (const byte*)"\x7f\x0a" "VISION_ALL")
// QDEF(MP_QSTR_Serial, (const byte*)"\xe5\x06" "Serial")
// QDEF(MP_QSTR_I2C, (const byte*)"\x5d\x03" "I2C")
QDEF(MP_QSTR_Baud9600, (const byte*)"\xb8\x08" "Baud9600")
QDEF(MP_QSTR_Baud19200, (const byte*)"\x2d\x09" "Baud19200")
QDEF(MP_QSTR_Baud38400, (const byte*)"\xc8\x09" "Baud38400")
QDEF(MP_QSTR_Baud57600, (const byte*)"\xe3\x09" "Baud57600")
QDEF(MP_QSTR_Baud115200, (const byte*)"\xd0\x0a" "Baud115200")
QDEF(MP_QSTR_Baud230400, (const byte*)"\x52\x0a" "Baud230400")
QDEF(MP_QSTR_Baud460800, (const byte*)"\x1d\x0a" "Baud460800")
QDEF(MP_QSTR_Baud921600, (const byte*)"\x1b\x0a" "Baud921600")
QDEF(MP_QSTR_Status, (const byte*)"\x51\x06" "Status")
QDEF(MP_QSTR_XValue, (const byte*)"\x56\x06" "XValue")
QDEF(MP_QSTR_YValue, (const byte*)"\xb7\x06" "YValue")
QDEF(MP_QSTR_WidthValue, (const byte*)"\x68\x0a" "WidthValue")
QDEF(MP_QSTR_HeightValue, (const byte*)"\xd1\x0b" "HeightValue")
QDEF(MP_QSTR_Label, (const byte*)"\x63\x05" "Label")
QDEF(MP_QSTR_RValue, (const byte*)"\x1c\x06" "RValue")
QDEF(MP_QSTR_GValue, (const byte*)"\xe9\x06" "GValue")
QDEF(MP_QSTR_BValue, (const byte*)"\x0c\x06" "BValue")
QDEF(MP_QSTR_CallBackMode, (const byte*)"\x0f\x0c" "CallBackMode")
QDEF(MP_QSTR_DataFlowMode, (const byte*)"\x64\x0c" "DataFlowMode")
QDEF(MP_QSTR_EventMode, (const byte*)"\x2a\x09" "EventMode")
QDEF(MP_QSTR_ZoomDefault, (const byte*)"\x59\x0b" "ZoomDefault")
QDEF(MP_QSTR_Zoom1, (const byte*)"\x23\x05" "Zoom1")
QDEF(MP_QSTR_Zoom2, (const byte*)"\x20\x05" "Zoom2")
QDEF(MP_QSTR_Zoom3, (const byte*)"\x21\x05" "Zoom3")
QDEF(MP_QSTR_Zoom4, (const byte*)"\x26\x05" "Zoom4")
QDEF(MP_QSTR_Zoom5, (const byte*)"\x27\x05" "Zoom5")
QDEF(MP_QSTR_FPSNormal, (const byte*)"\xf3\x09" "FPSNormal")
QDEF(MP_QSTR_FPSHigh, (const byte*)"\x6e\x07" "FPSHigh")
QDEF(MP_QSTR_AutoWhiteBalance, (const byte*)"\xcb\x10" "AutoWhiteBalance")
QDEF(MP_QSTR_LockWhiteBalance, (const byte*)"\xcf\x10" "LockWhiteBalance")
QDEF(MP_QSTR_WhiteLight, (const byte*)"\xdc\x0a" "WhiteLight")
QDEF(MP_QSTR_YellowLight, (const byte*)"\x7f\x0b" "YellowLight")
QDEF(MP_QSTR_LevelDefault, (const byte*)"\x18\x0c" "LevelDefault")
QDEF(MP_QSTR_LevelSpeed, (const byte*)"\xb4\x0a" "LevelSpeed")
QDEF(MP_QSTR_LevelBalance, (const byte*)"\x75\x0c" "LevelBalance")
QDEF(MP_QSTR_LevelAccuracy, (const byte*)"\xee\x0d" "LevelAccuracy")
QDEF(MP_QSTR_MU_SHAPE_CARD_TICK, (const byte*)"\xec\x12" "MU_SHAPE_CARD_TICK")
QDEF(MP_QSTR_MU_SHAPE_CARD_CROSS, (const byte*)"\x47\x13" "MU_SHAPE_CARD_CROSS")
QDEF(MP_QSTR_MU_SHAPE_CARD_CIRCLE, (const byte*)"\xab\x14" "MU_SHAPE_CARD_CIRCLE")
QDEF(MP_QSTR_MU_SHAPE_CARD_SQUARE, (const byte*)"\x58\x14" "MU_SHAPE_CARD_SQUARE")
QDEF(MP_QSTR_MU_SHAPE_CARD_TRIANGLE, (const byte*)"\xb7\x16" "MU_SHAPE_CARD_TRIANGLE")
QDEF(MP_QSTR_MU_TRAFFIC_CARD_FORWARD, (const byte*)"\x80\x17" "MU_TRAFFIC_CARD_FORWARD")
QDEF(MP_QSTR_MU_TRAFFIC_CARD_LEFT, (const byte*)"\x60\x14" "MU_TRAFFIC_CARD_LEFT")
QDEF(MP_QSTR_MU_TRAFFIC_CARD_RIGHT, (const byte*)"\x7b\x15" "MU_TRAFFIC_CARD_RIGHT")
QDEF(MP_QSTR_MU_TRAFFIC_CARD_TURN_AROUND, (const byte*)"\x3a\x1b" "MU_TRAFFIC_CARD_TURN_AROUND")
QDEF(MP_QSTR_MU_TRAFFIC_CARD_PARK, (const byte*)"\x73\x14" "MU_TRAFFIC_CARD_PARK")
QDEF(MP_QSTR_MU_COLOR_UNKNOWN, (const byte*)"\xc8\x10" "MU_COLOR_UNKNOWN")
QDEF(MP_QSTR_MU_COLOR_BLACK, (const byte*)"\x87\x0e" "MU_COLOR_BLACK")
QDEF(MP_QSTR_MU_COLOR_WHITE, (const byte*)"\x67\x0e" "MU_COLOR_WHITE")
QDEF(MP_QSTR_MU_COLOR_RED, (const byte*)"\xd3\x0c" "MU_COLOR_RED")
QDEF(MP_QSTR_MU_COLOR_YELLOW, (const byte*)"\x64\x0f" "MU_COLOR_YELLOW")
QDEF(MP_QSTR_MU_COLOR_GREEN, (const byte*)"\x5b\x0e" "MU_COLOR_GREEN")
QDEF(MP_QSTR_MU_COLOR_CYAN, (const byte*)"\x75\x0d" "MU_COLOR_CYAN")
QDEF(MP_QSTR_MU_COLOR_BLUE, (const byte*)"\xde\x0d" "MU_COLOR_BLUE")
QDEF(MP_QSTR_MU_COLOR_PURPLE, (const byte*)"\xae\x0f" "MU_COLOR_PURPLE")
QDEF(MP_QSTR_Led1, (const byte*)"\xb9\x04" "Led1")
QDEF(MP_QSTR_Led2, (const byte*)"\xba\x04" "Led2")
QDEF(MP_QSTR_LedClose, (const byte*)"\xfe\x08" "LedClose")
QDEF(MP_QSTR_LedRed, (const byte*)"\x3b\x06" "LedRed")
QDEF(MP_QSTR_LedGreen, (const byte*)"\x73\x08" "LedGreen")
QDEF(MP_QSTR_LedYellow, (const byte*)"\x2c\x09" "LedYellow")
QDEF(MP_QSTR_LedBlue, (const byte*)"\xd6\x07" "LedBlue")
QDEF(MP_QSTR_LedPurple, (const byte*)"\xe6\x09" "LedPurple")
QDEF(MP_QSTR_LedCyan, (const byte*)"\x3d\x07" "LedCyan")
QDEF(MP_QSTR_LedWhite, (const byte*)"\x4f\x08" "LedWhite")
